...
urlpatterns = [
    ...
    path('show/<int:after_id>', views.show, name='show'),
    path('show/<int:after_id>/<int:comment_id>', views.show, name='show'),
    path('create', views.create, name='create'),
    path('create/<str:tag>', views.create, name='create'),
    path('edit/<int:after_id>', views.edit, name='edit'),
    path('delete/<int:after_id>', views.delete, name='delete'),
    # 글쓰기 이미지 임시 업로드
